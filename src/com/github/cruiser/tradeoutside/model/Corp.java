 ...
 */
@Entity
@Table(name = "CORP", uniqueConstraints = { @UniqueConstraint(columnNames = { "busiNo" }) })
public class Corp implements Serializable, Model {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && obj.getClass() == Corp.class) {
            Corp corp = (Corp) obj;
    ...
    public String toString() {
        ...
        output.append("商户：（").append("\n商户号: ").append(busiNo)
                .append("\ndcc手续费率: ").append(dccRate).append("\nedc手续费率: ")
                .append(edcRate);
