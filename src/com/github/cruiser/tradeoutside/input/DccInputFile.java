...
public class DccInputFile extends InputFile {
    ...
    public static TradeDcc fillerByFixedLength(String oneline) throws Exception {
        ...
        String[] fieldName = { "TxnTim", "TxnCod", "SeqNum", "TermId",
                "AcpAdr", "ActNo", "ValDat", "TxnAmt", "Tips", "aRspCd",
                "TxnDat", "BusiNo", "CrdTyp", "ActDat" };// 各字段set方法名称

        int[] fieldFixedLength = { 6, 4, 12, 8, 40, 19, 4, 12, 12, 6, 8, 15, 1,
                8 };// 各字段长度

        Class<?>[][] fieldType = { { String.class }, { String.class },
                { String.class }, { String.class }, { String.class },
                { String.class }, { String.class }, { BigDecimal.class },
                { String.class }, { String.class }, { String.class },
                { String.class }, { String.class }, { String.class } };// set方法对应的参数类型

        Class<?> _reflectClass = Class
                .forName("com.github.cruiser.tradeoutside.trade.TradeDcc");
        ...
        for (int indexOfField = 0; indexOfField < fieldFixedLength.length; indexOfField++) {
            ...
            Object[] parmValue = InputFile.getFieldArray(fieldValue.toString(),
                    fieldType[indexOfField][0]);// = {fieldValue.toString()};
