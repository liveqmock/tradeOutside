...
public class CreateTables {
    ...
    public static void main(String[] args) {
        ...
        test.setProperty("hibernate.connection.driver_class",
                "net.sourceforge.jtds.jdbc.Driver");
        test.setProperty("hibernate.connection.url",
                "jdbc:jtds:sybase://182.53.15.211:6600/middb");
        test.setProperty("hibernate.connection.username", "miduser");
        test.setProperty("hibernate.connection.password", "miduser");
        test.setProperty("hibernate.dialect",
